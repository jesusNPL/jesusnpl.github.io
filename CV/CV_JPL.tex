...
\normalfont As of June 2023, I have published 30 articles in indexed journals, 11 articles in other peer-reviewed journals (non-indexed journals), 4 peer-reviewed book chapters and 4 non peer-reviewed book chapters.
...
{3.} {Moulatlet, G.M., B. Kusumoto,} {\bf{J.N. Pinto-Ledezma}}, { T. Shiono, Y. Kubota and F. Villalobos. (Second revision). Global patterns of phylogenetic beta-diversity components in angiosperms.} {\em Journal of Vegetation Science.}
...
\item 1. Subject-Matter Editor {\bf --} {\bf Ecological Monographs (ESA)} 
\item 2. Editorial Board {\bf --} {\bf Kempffiana} 
\item 3. Subject-Matter Editor - special issue: {\em Applications of spectral biology and remote sensing for deciphering the causes and consequences of plant biodiversity across scales} {\bf --} {\bf Ecology (ESA)}
\item 4. Guest Associate Editor in Models in Ecology and Evolution {\bf --} {\bf Frontiers in Ecology and Evolution}
